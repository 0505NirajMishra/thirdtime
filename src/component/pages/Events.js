...
const Events = () => {
  ...
  const getdata = () => {
    fetch('https://thecompletesoftech.com/kotatimes/admin/api/form_Events/all?X-Api-Key=74121DE3232D437180D63745C66D8E29'
      , {
        headers: {
                ...
                <div className="col-lg-3 col-md-6 mb-4 mb-lg-0 mt-5">
                  <div className="card shadow-sm border-0 rounded">
                    <div className="card-body p-0">
                      <img
                        src={"https://thecompletesoftech.com/kotatimes/admin/uploads/form_Gallery/" + demo.Events_images}
                        alt
